...
@Controller
@Scope("prototype")
public class RegistAction extends BaseAction<User> implements
		ServletRequestAware
{
	...
	public void sendMessage() {
		if (model != null && !model.getStatus()) { // 没有验证
			...
			StringBuffer content = new StringBuffer("亲爱的" + model.getUsername()
					+ " :您好!<br>");
			content.append(
					"&nbsp;&nbsp;&nbsp;&nbsp;感谢您注册 yechblog，您只要点击下面的链接，激活您的账号，便可以享受 yechblog 各项服务。")
					.append("<br><br>")
	...
	public void validateDoRegist() {
		...
		if (!identifyCode.toLowerCase()
				.equals(((String) (ActionContext.getContext().getSession()
